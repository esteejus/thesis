...
\begin{figure}[!htb]%
    \centering
    \subfloat[$\tin{108}{124}$ system]{{\includegraphics[width=.45\textwidth,valign=c]{beamAngle-Sn108.png} \label{fig:beamangle108}}}%
    \qquad
    \subfloat[ $\tin{112}{124}$ system]{{\includegraphics[width=.45\textwidth,valign=c]{beamAngle-Sn112.png} \label{fig:beamangle112}}}%
    
    \subfloat[ $\tin{124}{112}$ system]{{\includegraphics[width=.45\textwidth,valign=c]{beamAngle-Sn124.png} \label{fig:beamangle124}}}%
    \qquad
    \subfloat[$\tin{132}{124}$ system]{{\includegraphics[width=.45\textwidth,valign=c]{beamAngle-Sn132.png} \label{fig:beamangle132}}}%
...
\caption{Estimate of the impact parameter from the track multiplicity from \cite{jon}.}
\label{fig:impactPar}
\end{figure}
...
\begin{figure}[!htb]%
    \centering
    \subfloat[ $\tin{108}{112}$ system. ]{{\includegraphics[width=.9\textwidth,valign=c]{angularCut-pim-Sn108.png} \label{fig:pim108angle}}}%
    \qquad
    \subfloat[$\tin{132}{124}$ system. ]{{\includegraphics[width=.9\textwidth,valign=c]{angularCut-pim-Sn132.png} \label{fig:pim132angle}}}%
...
\begin{figure}[!htb]%
    \centering
    \subfloat[ $\tin{108}{112}$ system.]{{\includegraphics[width=.9\textwidth,valign=c]{angularCut-pip-Sn108.png} \label{fig:pip108angle}}}%
    \qquad
    \subfloat[$\tin{132}{124}$ system.]{{\includegraphics[width=.9\textwidth,valign=c]{angularCut-pip-Sn132.png} \label{fig:pip132angle}}}%
     \caption{Measured $\pi^+$ angular distribution for the two spherical angles $\theta$ and $\phi$.}
        \label{fig:pip}
\end{figure}
...
\section{Correcting Pion Spectra (Efficiency and Acceptance)}
...
\section{Pion Statistical Error}
