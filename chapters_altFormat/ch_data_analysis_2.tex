...
\begin{figure}[!htb]%
    \centering
    \subfloat[ $\tin{108}{112}$ system. ]{{\includegraphics[width=.8\textwidth,valign=c]{angularCut-pim-Sn108.png} \label{fig:pim108angle}}}%
    \qquad
    \subfloat[$\tin{132}{124}$ system. ]{{\includegraphics[width=.8\textwidth,valign=c]{angularCut-pim-Sn132.png} \label{fig:pim132angle}}}%
...
\begin{figure}[!htb]%
    \centering
    \subfloat[ $\tin{108}{112}$ system.]{{\includegraphics[width=.8\textwidth,valign=c]{angularCut-pip-Sn108.png} \label{fig:pip108angle}}}%
    \qquad
    \subfloat[$\tin{132}{124}$ system.]{{\includegraphics[width=.8\textwidth,valign=c]{angularCut-pip-Sn132.png} \label{fig:pip132angle}}}%
     \caption{Measured $\pi^+$ angular distribution for the two spherical angles $\theta$ and $\phi$.}
        \label{fig:pip}
\end{figure}
