...
\begin{figure}[!htb]%
    \centering
    \subfloat[Wires open]{{\includegraphics[width=.45\textwidth,valign=t]{wires_open.pdf} \label{fig:wires_open}}}%
    \qquad
    \subfloat[Wires closed]{{\includegraphics[width=.39\textwidth,valign=t]{wires_closed.pdf} \label{fig:wires_closed}}}%
...
\begin{figure}[!htb]%
    \centering
    \subfloat[On configurations where all wires are the same voltage.]{{\includegraphics[width=.45\textwidth,valign=t]{averageTransparency.png} \label{fig:ggAvgTrans}}}%
    \qquad
    \subfloat[Off configuration where adjacent wires have a voltage difference of $2 \Delta V$.]{{\includegraphics[width=.45\textwidth,valign=t]{transparencyDeltaV.png} \label{fig:ggDeltaVTrans}}}%
...
\begin{figure}[!htb]%
    \centering
    \subfloat[${}^{124}$Xe primary beam trigger.]{{\includegraphics[width=.45\textwidth,valign=t]{DataTrigger1.png} \label{fig:dataTrigger1}}}%
    \qquad
    \subfloat[${}^{238}$U primary beam trigger.]{{\includegraphics[width=.45\textwidth,valign=t]{DataTrigger2.png} \label{fig:dataTrigger2}}}%
