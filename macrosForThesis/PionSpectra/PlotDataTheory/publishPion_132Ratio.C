...
TFile *pBUU_stiff_no_f = TFile::Open("/home/justin/Homework/pBUU/K265EM070/input_for_esym.info/pBUUStiff_r-1.root");
  ...
  */
  ...
  double y[8] = {22.6858,5.88988,3.11959,2.35538,2.1039,1.72789,1.51432,1.51432};
  double  xe[8] = {0,0,0,0,0,0,0,0};
  double  yel[8] = {16.6858,1.46488,1.09459,0.930383,0.678901,0.452894,0.53932,.53932};
  double  yeh[8] = {19.3142,1.38512,1.15541,0.869617,0.671099,0.447106,0.51068,.51068};
  TGraphAsymmErrors *boot_stiff = new TGraphAsymmErrors(8,x,y,xe,xe,yel,yeh);

  double x_soft[8] = {15,45,75,105,145,205,270,300};
  double y_soft[8] = {21.6752,6.12583,3.35712,2.55595,2.30918,1.84622,1.62233,1.62233};
  double  xe_soft[8] = {0,0,0,0,0,0,0,0};
  double  yel_soft[8] = {15.6752,1.40083,1.03212,0.830945,0.734179,0.571215,0.647325,.647325};
  double  yeh_soft[8] = {20.3248,1.44917,0.917875,0.819055,0.765821,0.778785,0.702675,.702675};
