...
void publishPionsSpectra132Sn()
{

 TFile *pBUU_soft_no_f = TFile::Open("/home/justin/Homework/pBUU/K210EM100/input_for_esym.info/pBUUSoft.root");
  TGraphErrors *pBUU_soft_no_pim = (TGraphErrors *) pBUU_soft_no_f->Get("pim132");
  TGraphErrors *pBUU_soft_no_pip = (TGraphErrors *) pBUU_soft_no_f->Get("pip132");
  
  TFile *pBUU_stiff_no_f = TFile::Open("/home/justin/Homework/pBUU/K210EM100/input_for_esym.info/pBUUStiff.root");
  TGraphErrors *pBUU_stiff_no_pim = (TGraphErrors *) pBUU_stiff_no_f->Get("pim132");
  TGraphErrors *pBUU_stiff_no_pip = (TGraphErrors *) pBUU_stiff_no_f->Get("pip132");
  
  TFile *amdJAM55_f = TFile::Open("/home/justin/Homework/AMDJAM/highStat/input_for_esym.info/AMDJAML55new.root");
  TGraphErrors *amdJAM55_pim = (TGraphErrors *) amdJAM55_f->Get("pim132");
  TGraphErrors *amdJAM55_pip = (TGraphErrors *) amdJAM55_f->Get("pip132");
  
  TFile *amdJAM152_f = TFile::Open("/home/justin/Homework/AMDJAM/highStat/input_for_esym.info/AMDJAML152new.root");
  TGraphErrors *amdJAM152_pim = (TGraphErrors *) amdJAM152_f->Get("pim132");
  TGraphErrors *amdJAM152_pip = (TGraphErrors *) amdJAM152_f->Get("pip132");

  TFile *urQMD_46_f = TFile::Open("/home/justin/Homework/UrQMD/input_for_esym.info/UrQMDL46.root");
  TGraphErrors *urQMD_46_pim = (TGraphErrors *) urQMD_46_f->Get("pim132");
  TGraphErrors *urQMD_46_pip = (TGraphErrors *) urQMD_46_f->Get("pip132");
  
  TFile *urQMD_104_f = TFile::Open("/home/justin/Homework/UrQMD/input_for_esym.info/UrQMDL104.root");
  TGraphErrors *urQMD_104_pim = (TGraphErrors *) urQMD_104_f->Get("pim132");
  TGraphErrors *urQMD_104_pip = (TGraphErrors *) urQMD_104_f->Get("pip132");

  TFile *imQMD_05_f = TFile::Open("/home/justin/Homework/IQMD-BNU/input_for_esym.info/IQMD-BNUg05.root");
  TGraphErrors *imQMD_05_pim = (TGraphErrors *) imQMD_05_f->Get("pim132");
  TGraphErrors *imQMD_05_pip = (TGraphErrors *) imQMD_05_f->Get("pip132");
  
  TFile *imQMD_20_f = TFile::Open("/home/justin/Homework/IQMD-BNU/input_for_esym.info/IQMD-BNUg20.root");
  TGraphErrors *imQMD_20_pim = (TGraphErrors *) imQMD_20_f->Get("pim132");
  TGraphErrors *imQMD_20_pip = (TGraphErrors *) imQMD_20_f->Get("pip132");

  TFile *tuQMD_05_f = TFile::Open("/home/justin/Homework/TuQMD/new-highStat/input_for_esym.info/TuQMDg05.root");
  TGraphErrors *tuQMD_05_pim = (TGraphErrors *) tuQMD_05_f->Get("pim132");
  TGraphErrors *tuQMD_05_pip = (TGraphErrors *) tuQMD_05_f->Get("pip132");
  
  TFile *tuQMD_20_f = TFile::Open("/home/justin/Homework/TuQMD/new-highStat/input_for_esym.info/TuQMDg20.root");
  TGraphErrors *tuQMD_20_pim = (TGraphErrors *) tuQMD_20_f->Get("pim132");
  TGraphErrors *tuQMD_20_pip = (TGraphErrors *) tuQMD_20_f->Get("pip132");

  TFile *xbuu_f = TFile::Open("/home/justin/Homework/xBUU/old/input_for_esym.info/xBUU.root");
  TGraphErrors *xbuu_pim = (TGraphErrors *) xbuu_f->Get("pim132");
  TGraphErrors *xbuu_pip = (TGraphErrors *) xbuu_f->Get("pip132");

  TFile *xbuu120_f = TFile::Open("/home/justin/Homework/xBUU/new/input_for_esym.info/xBUU_skyrmeL120.root");
  TGraphErrors *xbuu120_pim = (TGraphErrors *) xbuu120_f->Get("pim132");
  TGraphErrors *xbuu120_pip = (TGraphErrors *) xbuu120_f->Get("pip132");
  
  auto xbuu_pim_sum = CombineGraph(xbuu_pim,xbuu120_pim);
  auto tuQMD_pim_sum = CombineGraph(tuQMD_05_pim,tuQMD_20_pim);
  ...
  leg_2->SetHeader("{}^{132}Sn +{}^{124}Sn");
  leg_2->AddEntry(pim_sn132,"#pi^{-}","lpe");
  leg_2->AddEntry(pip_sn132,"#pi^{+} (x10^{-1} )","lpe");
  
  TLegend *leg_3 = new TLegend(.55,.2,.7,.6);
  leg_3->AddEntry(pip_sn132,"#pi^{+} (x10^{-1} )","lpe");
  ...
  */
  pim_sn132->DrawCopy("same E1");

  pip_sn132->DrawCopy("same E1");
  ...
  */
  ...
  cvs->SaveAs("pionSpectra_sn132_sum.png");
