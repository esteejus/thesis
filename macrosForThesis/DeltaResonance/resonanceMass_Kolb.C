  ...
  for(int i = 0; i < np; i++)
    {
      ...
      norm = 3.8239950e-48;
      t1fcn->SetPoint(i,mass,integrand->Integral(0,10,0,10000)/norm);      

      integrand->SetParameter(1,T2);
      norm = 6.3578093e-24;
      t2fcn->SetPoint(i,mass,integrand->Integral(0,10,0,10000)/norm);      

      integrand->SetParameter(1,T3);
      norm = 1.5502147e-14;
      t3fcn->SetPoint(i,mass,integrand->Integral(0,10,0,10000)/norm);      

      integrand->SetParameter(1,T4);
      norm = 5.3697679e-10;
      t4fcn->SetPoint(i,mass,integrand->Integral(0,10,0,10000)/norm);      
    }
